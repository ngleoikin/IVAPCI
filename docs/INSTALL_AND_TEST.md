...
> 推荐测试组合
> 1) **冒烟**：`--scenarios EASY-linear-weak --n 200 --seeds 0`，方法用 `naive ivapci_v2_1 ivapci_v2_1_glm ivapci_v2_1_pacd_glm ivapci_gold` 对比 RF/GLM/分段 DR。
...
python scripts/run_simulation_benchmark.py \
  ...
  --seeds 0 1 \
  --n 200 \
  --methods naive dr_glm dr_rf oracle_U ivapci_v2_1 ivapci_v2_1_glm ivapci_v2_1_pacd_glm ivapci_gold pacdt_v3_0 \
